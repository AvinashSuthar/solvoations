...
const Projects = () => {
  ...
  return (
    <section id="projects" className="min-h-screen bg-black px-5 py-10">
      <h2 className="text-white text-3xl font-bold mb-6 text-center sm:text-left">
        Our Projects
      </h2>
      ...
      <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
        {filteredProjects.map((p) => (
          ...
          >
            ...
            <div className="p-4">
              <p className="text-sm text-green-400">{p.progress}</p>
              <h3 className="text-xl font-semibold text-white">{p.title}</h3>
              <p className="text-white mt-1 text-sm">{p.description}</p>
              <a
                href={p.links.live}
                target="_blank"
